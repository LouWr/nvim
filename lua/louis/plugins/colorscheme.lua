		...
		require("monokai-pro").setup({
			override = function(c)
				return {
					...
					["@variable.builtin"] = { fg = c.base.red, italic = true },
					["@variable.parameter"] = { fg = c.base.orange },
					["@variable.member"] = { fg = c.base.cyan },

					-- Properties and fields
					["@property"] = { fg = c.base.cyan },
					["@field"] = { fg = c.base.cyan },

					-- Constants and values
					["@constant"] = { fg = c.base.magenta },
					["@constant.builtin"] = { fg = c.base.magenta, italic = true },
					["@number"] = { fg = c.base.magenta },
					["@boolean"] = { fg = c.base.magenta },

					-- String values
					["@string"] = { fg = c.base.green },

					-- Function parameters
					["@parameter"] = { fg = c.base.orange },

					-- General identifier fallback
					Identifier = { fg = c.base.green },
				}
			end,
		})
